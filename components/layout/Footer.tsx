    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-white">PAJU ON</span>
                <span className="text-xs text-gray-400 -mt-1">파주온</span>
              </div>
            </div>
            <p className="text-sm text-gray-400 mb-4">
              파주 시민을 위한 참여형 로컬 커뮤니티 플랫폼
              <br />
              파주가 켜진다, 파주의 모든 것이 있다
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/support/terms" className="hover:text-white transition-colors">
                  이용약관
                </Link>
              </li>
              <li>
                <Link href="/support/privacy" className="hover:text-white transition-colors">
                  개인정보처리방침
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} PAJU ON (파주온). All rights reserved.</p>
          <p className="mt-2">모든 기능은 무료로 제공됩니다.</p>
        </div>
      </div>
    </footer>
  );
